...
export function apply(ctx: Context, config: Config = {}): void {
  ...
  ctx.on('agent/turn-stopping', async ({ agent, signal }) => {
    ...
    const structured = finalPreferred ? undefined : analyzeStructuredRoute(snapshot, selected.autoRouteMaxCandidates, selected.autoRouteMaxItemChars, selected.autoRouteMaxInputChars) as RouteDecision
