...
export function partialStats(error: unknown): RunStats | undefined {
  const value = partialUsage<Partial<RunStats> & UsageStats>(error)
 ...
 */
export function mergeRunStats(target: RunStats, source: (UsageStats & Partial<RunStats>) | undefined): void {
...
function attachBilled(error: unknown, usage: UsageStats): void {
