...
async function callTopLogprobs(route, model, prompt, maxTokens, reasoningEffort, signal, images, attempt = 1) {
...
async function callExplicitTag(config, prompt, signal, images, attempt) {
	...
	for (const image of images ?? []) {
		...
		if (pending === void 0) {
			pending = config.attachments.saveImage({
				data: image.data,
...
//# sourceMappingURL=caller-D1ZQNsVU.js.map