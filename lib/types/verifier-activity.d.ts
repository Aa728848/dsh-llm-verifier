 ...
 */
import type { Reservation, RouterCycleObserver } from './router.ts';
 ...
 */
export declare const ACTIVITY_SETTLED_TTL_MS = 20000;
/**
 ...
 */
export declare const ACTIVITY_ACTIVE_TTL_MS = 600000;
/**
 ...
 */
export declare function classifyProcessOutcome(outcome: string, replayed: 'original' | 'candidate' | 'none'): ActivityOutcome;
/**
 ...
 */
export declare function reservationActivity(reservation: Pick<Reservation, 'id' | 'phase' | 'expectedCalls'>, startedAt: number): ActivityActive | undefined;
/**
 ...
 */
export declare function reservationPromotion(reservation: Pick<Reservation, 'phase' | 'expectedCalls'>): Pick<ActivityActive, 'phase' | 'expectedCalls'> & {
    destination?: ActivityDestination;
} | undefined;
/**
 ...
 */
export declare function reservationSettled(reservation: Pick<Reservation, 'id' | 'phase'>, outcome: 'committed' | 'failed'): {
    stage: ActivityStage;
    outcome: ActivityOutcome;
} | undefined;
/**
 ...
 */
export declare function createActivityObserver(activities: VerifierActivities, now?: () => number): RouterCycleObserver;
/**
 ...
 */
export declare class VerifierActivities {
     ...
     */
    update(sessionId: string, cycleId: string, patch: Partial<Pick<ActivityActive, 'phase' | 'destination' | 'candidates' | 'expectedCalls'>>): boolean;
    /**
     * Retire one cycle.
     *
     ...
     */
    finish(sessionId: string, cycleId: string, outcome: ActivityOutcome | undefined, now: number): boolean;
    /**
...
//# sourceMappingURL=verifier-activity.d.ts.map