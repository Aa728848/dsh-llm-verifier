...
import { zh, en, dictionaries, toolLabels, tFormat, useLanguage, detectLanguage, compact, money, duration, dateTime, } from "./client-i18n.js";
export { zh, en, dictionaries, toolLabels, tFormat, useLanguage, detectLanguage, compact, money, duration, dateTime };
...
export function apply(ctx) {
    ...
    const existingTabs = typeof ctx.get === 'function' ? ctx.get('sidebarRightTabs') : undefined;
    if (existingTabs) {
