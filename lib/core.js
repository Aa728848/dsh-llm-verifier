...
*/
function selectPairs(count, seed = 0, requestedPivots = 2) {
	if (count <= 2) return {
		ring: [[0, 1]],
		pivots: [],
		pairs: [[0, 1]]
	...
	accumulatePairs(ring, /* @__PURE__ */ new Map(), wins, counts);
...
//#endregion
export { DEFAULT_CRITERIA, DEFAULT_GROUND_TRUTH_NOTE, GRANULARITY, LETTERS, SCALE_DESCRIPTION, UNTRUSTED_EVIDENCE_NOTE, accumulatePairs, bradleyTerry, buildPairwisePrompt, buildProgressPrompt, evidenceNonce, extractProgressScore, extractScore, normalizeScoreLetter, pivotRoundPairs, rankScores, renderDelimitedBlock, ringCycle, seededRandom, selectPairs, topPivots };
