	...
	while (true) {
		...
		try {
			...
			if (failedAttempts > 0 && typeof value === "object" && value !== null) {
				...
				if (usage !== void 0) usage.usageIncomplete = true;
			}
			return value;
		} catch (error) {
			if (signal?.aborted) {
				if (typeof signal.reason === "object" && signal.reason !== null) signal.reason[REQUEST_ATTEMPTS] = attempt;
				throw signal.reason;
			}
...
//# sourceMappingURL=caller-CrMyFou4.js.map