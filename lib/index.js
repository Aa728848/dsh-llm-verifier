...
function partialStats(error) {
	...
	const value = error[PARTIAL_STATS];
	return typeof value === "object" && value !== null ? value : void 0;
}
function attachPartialStats(error, stats) {
	if (typeof error === "object" && error !== null) error[PARTIAL_STATS] = stats;
}
