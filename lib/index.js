...
import { A as verificationFailed, C as latestDirectUserSeq, D as semanticDecision, E as routedRepeats, F as ScoreCache, I as SingleFlight, L as resolveCacheFile, M as extractSession, N as sanitizeVerifierText, O as semanticReferencesVisible, P as sessionEvents, R as stableHash, S as itemBudget, T as parseSemanticRoute, _ as buildSemanticRoutePrompt, a as compareRouteFeedbackDetail, b as inspectDeliveryPhase, c as selectRouteFeedbackDetail, d as AutoVerifierRouter, f as MAX_ROUTED_CHECKPOINTS, g as buildEvidenceIndex, h as boundDecision, i as automaticFeedback, j as verificationVerdict, k as semanticRouteHint, l as sessionAccepted, m as analyzeStructuredRoute, n as PROPOSAL_FEEDBACK_NOTE, o as failedAcceptanceCriteria, p as RECOVERY_FAILURE_CONTEXT_CHARS, r as analyzeAutoTask, s as isSubagentSession, t as MAX_ROUTE_FEEDBACK_CHARS, u as topScoreIndices, v as buildSemanticRouteView, w as nextDiagnosticCycleId, x as inspectRecoverySignal, y as estimateRoutedCalls } from "./auto-DAMeKRkK.js";
...
function resolveConfig(config = {}) {
	...
	if (alternativeModel !== "" && !/^[^\s/]+\/[^\s]+$/u.test(alternativeModel)) throw new Error("llm-verifier: autoProcessAlternativeModel must be \"provider/model\" or empty");
	const values = {
...
*/
function resolveAlternativeTarget(value) {
	...
	*/
	async *handle(options, next, intent) {
		...
		const observation = {
			...
			...alternativeTarget === void 0 ? {} : { alternativeModel: alternativeTarget.provider + "/" + alternativeTarget.model }
		};
		...
		try {
			...
			if (staleBeforeGeneration !== void 0) {
				...
				await this.report({
					...
					observation,
					startedAt,
					outcome: staleBeforeGeneration,
					replayed: "original",
					generatedCalls: 0,
					judgeCalls: 0,
					sameCandidate: false,
					usage: blankProcessStats(),
					...staleBeforeGeneration === "canceled" ? { error: "the process-selection phase was cancelled" } : {}
				});
				return;
			}
			let alternative;
