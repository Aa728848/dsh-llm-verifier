...
import { a as attachUsage, c as emptyUsage, f as partialUsage, g as resolveCapabilityFile, h as TopLogprobCapabilityCache, i as addUsage, m as requestAttempts, o as callVerifier, p as predictScoringChannel, r as RequestLimiter, s as callVerifierText, u as generateCandidate } from "./caller-Blp4l--v.js";
import { A as semanticRouteHint, C as itemBudget, D as routedRepeats, E as parseSemanticRoute, F as sessionEvents, I as ScoreCache, L as SingleFlight, M as verificationVerdict, N as extractSession, O as semanticDecision, P as sanitizeVerifierText, R as resolveCacheFile, S as inspectRecoverySignal, T as nextDiagnosticCycleId, _ as buildEvidenceIndex, a as compareRouteFeedbackDetail, b as estimateRoutedCalls, c as isSubagentSession, d as topScoreIndices, f as AutoVerifierRouter, g as boundDecision, h as analyzeStructuredRoute, i as automaticFeedback, j as verificationFailed, k as semanticReferencesVisible, l as selectRouteFeedbackDetail, m as RECOVERY_FAILURE_CONTEXT_CHARS, n as PROPOSAL_FEEDBACK_NOTE, o as failedAcceptanceCriteria, p as MAX_ROUTED_CHECKPOINTS, r as analyzeAutoTask, s as hasPendingSubagents, t as MAX_ROUTE_FEEDBACK_CHARS, u as sessionAccepted, v as buildSemanticRoutePrompt, w as latestDirectUserSeq, x as inspectDeliveryPhase, y as buildSemanticRouteView, z as stableHash } from "./auto-DmyrNZXK.js";
...
function apply(ctx, config = {}) {
	...
	*/
	...
	ctx.on("agent/turn-stopping", async ({ agent, signal }) => {
		...
		const deliveryReady = delivery !== void 0 && delivery.todosComplete && delivery.verification !== void 0 && deliverySignature !== void 0 && !autoRouter.deliveryConsumed(agent, deliverySignature) && !subagentsPending && (evidence.eligible || forcedFromSeq !== void 0);
		...
		if (decision) {
			...
			if (reservation) try {
				...
				if (subagentsPending || forcedFromSeq === void 0 && !evidence.eligible && !gateArmed) {
		...
		if (subagentsPending || forcedFromSeq === void 0 && !evidence.eligible) {
