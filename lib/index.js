...
function apply(ctx, config = {}) {
	...
	ctx.tools.register(defineTool({
		...
		async execute(args, exec) {
			requireEnabled();
			return record("verifier_compare", exec, async () => {
	...
	ctx.tools.register(defineTool({
		...
		async execute(args, exec) {
			requireEnabled();
			return record("verifier_select", exec, async () => {
				const { verifier, selected } = await engine();
				return {
	...
	ctx.tools.register(defineTool({
		...
		async execute(args, exec) {
			requireEnabled();
			return record("verifier_track", exec, async () => {
				const { verifier, selected } = await engine();
				return {
	...
	ctx.tools.register(defineTool({
		...
		async execute(args, exec) {
			requireEnabled();
			return record("verifier_current_session", exec, async () => {
