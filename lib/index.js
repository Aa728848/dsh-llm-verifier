...
import { a as callVerifier, c as generateCandidate, d as TopLogprobCapabilityCache, f as resolveCapabilityFile, i as addUsage, l as generationClient, o as callVerifierText, r as RequestLimiter, s as emptyUsage, u as predictScoringChannel } from "./caller-z_vZTeNq.js";
import { C as resolveCacheFile, S as SingleFlight, _ as semanticRouteHint, a as sessionAccepted, b as sessionEvents, c as analyzeStructuredRoute, d as buildSemanticRoutePrompt, f as estimateRoutedCalls, g as semanticDecision, h as routedRepeats, i as isSubagentSession, l as boundDecision, m as parseSemanticRoute, n as automaticFeedback, o as AutoVerifierRouter, p as latestDirectUserSeq, r as failedAcceptanceCriteria, s as MAX_ROUTED_CHECKPOINTS, t as analyzeAutoTask, u as buildEvidenceIndex, v as extractSession, w as stableHash, x as ScoreCache, y as sanitizeVerifierText } from "./auto-B5V49e-A.js";
...
*/
function selectComparisonsUpperBound(count) {
	return count <= 2 ? 1 : count + (count - 2) * 2 + 1;
}
...
function apply(ctx, config = {}) {
	...
	*/
	...
	ctx.on("agent/turn-stopping", async ({ agent, signal }) => {
		...
		const structured = finalPreferred ? void 0 : analyzeStructuredRoute(snapshot, selected.autoRouteMaxCandidates, selected.autoRouteMaxItemChars, selected.autoRouteMaxInputChars);
