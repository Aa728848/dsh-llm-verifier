window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function processActivityText(view, t) {
			const active = view?.active;
			if (active !== void 0 && active !== null) {
				const candidates = typeof active.candidates === "number" && Number.isFinite(active.candidates) ? Math.max(2, Math.floor(active.candidates)) : 2;
		...
		*/
		...
		const PROCESS_ACTIVITY_POLL_MS = 1e3;
		/**
		...
		*/
		function ProcessActivityChip({ session, rpc }) {
			const t = dictionaries[useLanguage()];
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					...
					style: {
						...
						borderRadius: "50%",
						background: accent,
						opacity: rendered.tone === "busy" ? .65 : 1
					}
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: rendered.text })]
			});
		}
		function apply(ctx) {
		...
		exports.PROCESS_ACTIVITY_POLL_MS = PROCESS_ACTIVITY_POLL_MS;
		exports.ProcessActivityChip = ProcessActivityChip;
