window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const zh = {
			...
			"probe.running": "检测中…",
			"probe.title": "判官自检",
			"probe.note": "每个判官发一次真实调用，结果不计入统计",
		...
		const en = {
			...
			"probe.note": "One real call per judge; not counted in the statistics",
										...
										children: probe.value.judges.map((judge) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											...
											children: [
												...
												judge.ok ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
													judge.channel !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
														style: muted,
														children: tFormat(t["probe.channel"], { channel: judge.channel })
													}),
