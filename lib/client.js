window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const zh = {
			...
			"field.autoProcessSelection.help": "默认关闭。开启后，仅 smart 模式、且同一任务最近两次已完成的验证运行都失败时，才为下一次主模型请求额外生成一份备选回复，用 proposal 判据比较后只回放胜者。每任务最多购买 1 个周期，并同时消耗现有任务/会话路由额度、受模型调用预算与最终验收保留额度共同限制（同一会话的第二个任务仍可购买自己的周期）。裁判看到的是重建并限长过的视图：任务、约束、最近失败证据、工具定义与两份候选，全部先脱敏；工具动作无法完整容纳时回退原回复。选优不等于验收，之后的最终验收照常执行。关闭时完全不进入该路径：不生成候选、不调用裁判、不缓冲响应。",
			"field.captureDecisions.title": "保存决策快照",
			"field.captureDecisions.help": "把每次裁判调用的提示词与原始回答脱敏后限量存进本话题的 verifier/decisions-v1.json（每次调用 ≤ 12 次模型调用、单条记录 ≤ 3 万字符、按话题保留最近 40 条）。用于在统计看板里回答\"裁判为什么这么判\"，不参与任何判定。",
		...
		*/
		...
		function values(view) {
			...
			return {
				...
				autoTrackRepeats: Number(v.autoTrackRepeats ?? 3),
				...
				autoTrackCompletionThreshold: Number(v.autoTrackCompletionThreshold ?? .684),
				...
				criteriaPreset: v.criteriaPreset === "debug" || v.criteriaPreset === "research" || v.criteriaPreset === "ops" || v.criteriaPreset === "writing" || v.criteriaPreset === "custom" ? v.criteriaPreset : "coding",
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								style: row,
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Label, {
									title: t["field.criteriaPreset.title"],
									help: t["field.criteriaPreset.help"]
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("select", {
									style: selectStyle,
									disabled: busy,
									"aria-label": t["field.criteriaPreset.title"],
									value: draft.criteriaPreset,
									onChange: (e) => patch("criteriaPreset", e.target.value),
									children: [
										"coding",
										"debug",
										"research",
							...
							draft.criteriaPreset === "custom" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								style: row,
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Label, {
									title: t["field.criteriaFile.title"],
									help: t["field.criteriaFile.help"]
								}), textField("criteriaFile", "criteria/my-task.md")]
							}),
							draft.criteriaPreset !== "custom" && (() => {
								...
								return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("details", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("summary", {
										...
										children: buildPairwisePrompt(t["field.criteriaPreset.sampleTask"], t["field.criteriaPreset.sampleA"], t["field.criteriaPreset.sampleB"], first, "**IMPORTANT:** Focus on observed tool and terminal output as ground truth. Do NOT trust the agent's self-assessment or claims of success.")
									})]
								});
							})(),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								style: row,
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Label, {
									title: t["field.captureDecisions.title"],
									help: t["field.captureDecisions.help"]
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									role: "switch",
									"aria-checked": draft.captureDecisions,
									"aria-label": t["field.captureDecisions.title"],
									onClick: () => patch("captureDecisions", !draft.captureDecisions),
									style: toggleStyle(draft.captureDecisions),
									children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { style: toggleThumbStyle(draft.captureDecisions) })
								})]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								style: row,
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								style: row,
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Label, {
									title: t["field.autoProcessSelection.title"],
									help: t["field.autoProcessSelection.help"]
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									role: "switch",
									"aria-checked": draft.autoProcessSelection,
									"aria-label": t["field.autoProcessSelection.title"],
									onClick: () => patch("autoProcessSelection", !draft.autoProcessSelection),
									style: toggleStyle(draft.autoProcessSelection),
									children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { style: toggleThumbStyle(draft.autoProcessSelection) })
								})]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								style: row,
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								style: row,
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Label, {
									title: t["field.autoTrackRepeats.title"],
									help: t["field.autoTrackRepeats.help"]
								}), numeric("autoTrackRepeats", 1)]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								style: row,
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Label, {
