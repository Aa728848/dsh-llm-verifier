window.__ModuleLoader__.load({
	...
	factory: (require) => {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Label, {
									...
									type: "button",
									role: "switch",
									"aria-checked": draft.autoVerifyTeamTasks ?? true,
									"aria-label": t["field.autoVerifyTeamTasks.title"],
									onClick: () => patch("autoVerifyTeamTasks", !(draft.autoVerifyTeamTasks ?? true)),
									style: toggleStyle(draft.autoVerifyTeamTasks ?? true),
									children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { style: toggleThumbStyle(draft.autoVerifyTeamTasks ?? true) })
								})]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								style: row,
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Label, {
									...
									type: "button",
									role: "switch",
									"aria-checked": draft.autoVerifyPlanMode ?? true,
									"aria-label": t["field.autoVerifyPlanMode.title"],
									onClick: () => patch("autoVerifyPlanMode", !(draft.autoVerifyPlanMode ?? true)),
									style: toggleStyle(draft.autoVerifyPlanMode ?? true),
									children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { style: toggleThumbStyle(draft.autoVerifyPlanMode ?? true) })
								})]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								style: row,
			...
			(0, react.useEffect)(() => {
				...
				const fetchOverview = async () => {
					if (rpc && typeof rpc.call === "function") try {
						...
						if (result && result.ok === false) throw new Error(result.error?.message ?? t["stats.requestFailed"]);
					} catch (rpcError) {
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: t["table.title"] }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										style: muted,
										children: tFormat(t["table.toolCount"], { count: data?.tools.length ?? 0 })
									})]
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		function apply(ctx) {
			...
			const existingTabs = typeof ctx.get === "function" ? ctx.get("sidebarRightTabs") : void 0;
			if (existingTabs) registerRightSidebar(existingTabs);
