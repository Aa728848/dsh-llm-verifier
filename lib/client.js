			...
			const load = async () => {
				...
				try {
					...
					const next = {
						...
						failures: m.value.failures.map((f) => f.provider + ": " + f.message)
					};
					setLoaded(next);
		...
		function StatisticsPage({ sessionId, rpc }) {
			...
			(0, react.useEffect)(() => {
				...
				rpc.call("/llm-verifier", "statistics", {
					...
					if (!result.ok) throw new Error(result.error?.message ?? t["stats.requestFailed"]);
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: tFormat(t["stats.updatedAt"], { time: data ? dateTime(data.generatedAt, lang) : "--" })
							})] }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								style: {
									display: "flex",
									gap: 8,
